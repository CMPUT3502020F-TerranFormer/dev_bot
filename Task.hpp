...
struct Task {
    ...
    Task(enum AgentActions action, enum SourceAgent source, unsigned short priority, const sc2::Unit* target,
    ...
    const sc2::Unit* target;        // a specific unit to use, sometimes this is required, otherwise if the exact unit doesn't matter
